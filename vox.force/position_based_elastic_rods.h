...
public:
    ...
    //*
    //* @param rodConstraints contains the combined zero-stretch, bending and torsion constraints of the rod. The set of
    ...
    //* @param stiffnessCoefficientK diagonal matrix with material parameters for bending and torsion stiffness (eq. 5
    // in the paper)
...
public:
     ...
     * point:\n\n \f$C(\mathbf{p}_0, \mathbf{p}_1, \mathbf{p}_2) = \| ( 0.5 (\mathbf{p}_0 + \mathbf{p}_1) - \mathbf{p}_2
     * \| - L_0 = 0\f$\n\n
     *
     * @param p0 position of first particle
     * @param invMass0 inverse mass of first particle
