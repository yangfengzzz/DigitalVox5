...
template <>
inline OPEN3D_CPU_LINALG_INT getrf_cpu<float>(int layout,
                                              OPEN3D_CPU_LINALG_INT m,
                                              OPEN3D_CPU_LINALG_INT n,
                                              float* A_data,
                                              OPEN3D_CPU_LINALG_INT lda,
...
template <>
inline OPEN3D_CPU_LINALG_INT getrf_cpu<double>(int layout,
                                               OPEN3D_CPU_LINALG_INT m,
                                               OPEN3D_CPU_LINALG_INT n,
                                               double* A_data,
                                               OPEN3D_CPU_LINALG_INT lda,
...
template <>
inline OPEN3D_CPU_LINALG_INT getri_cpu<float>(int layout,
                                              OPEN3D_CPU_LINALG_INT n,
                                              float* A_data,
                                              OPEN3D_CPU_LINALG_INT lda,
                                              OPEN3D_CPU_LINALG_INT* ipiv_data) {
...
template <>
inline OPEN3D_CPU_LINALG_INT getri_cpu<double>(int layout,
                                               OPEN3D_CPU_LINALG_INT n,
                                               double* A_data,
                                               OPEN3D_CPU_LINALG_INT lda,
                                               OPEN3D_CPU_LINALG_INT* ipiv_data) {
...
inline OPEN3D_CPU_LINALG_INT gesvd_cpu<float>(int layout,
                                              ...
                                              OPEN3D_CPU_LINALG_INT ldvt,
                                              float* superb) {
    return LAPACKE_sgesvd(layout, jobu, jobvt, m, n, A_data, lda, S_data, U_data, ldu, VT_data, ldvt, superb);
}
...
inline OPEN3D_CPU_LINALG_INT gesvd_cpu<double>(int layout,
                                               ...
                                               OPEN3D_CPU_LINALG_INT ldvt,
                                               double* superb) {
    return LAPACKE_dgesvd(layout, jobu, jobvt, m, n, A_data, lda, S_data, U_data, ldu, VT_data, ldvt, superb);
}

#ifdef BUILD_CUDA_MODULE
template <typename scalar_t>
inline cusolverStatus_t getrf_cuda_buffersize(cusolverDnHandle_t handle, int m, int n, int lda, int* len) {
    LOGE("Unsupported data type.");
...
template <typename scalar_t>
inline cusolverStatus_t geqrf_cuda_buffersize(cusolverDnHandle_t handle, int m, int n, int lda, int* len) {
    LOGE("Unsupported data type.");
    return CUSOLVER_STATUS_INTERNAL_ERROR;
}
...
template <typename scalar_t>
inline cusolverStatus_t gesvd_cuda_buffersize(cusolverDnHandle_t handle, int m, int n, int* len) {
    LOGE("Unsupported data type.");
    return CUSOLVER_STATUS_INTERNAL_ERROR;
}
...
template <>
inline cusolverStatus_t getrf_cuda_buffersize<float>(cusolverDnHandle_t handle, int m, int n, int lda, int* len) {
    return cusolverDnSgetrf_bufferSize(handle, m, n, NULL, lda, len);
}

template <>
inline cusolverStatus_t getrf_cuda_buffersize<double>(cusolverDnHandle_t handle, int m, int n, int lda, int* len) {
    return cusolverDnDgetrf_bufferSize(handle, m, n, NULL, lda, len);
}

template <>
inline cusolverStatus_t getrf_cuda<float>(
        cusolverDnHandle_t handle, int m, int n, float* A_data, int lda, float* workspace, int* ipiv_data, int* dinfo) {
    return cusolverDnSgetrf(handle, m, n, A_data, lda, workspace, ipiv_data, dinfo);
}
...
inline cusolverStatus_t getrf_cuda<double>(cusolverDnHandle_t handle,
                                           ...
                                           int* ipiv_data,
                                           int* dinfo) {
    return cusolverDnDgetrf(handle, m, n, A_data, lda, workspace, ipiv_data, dinfo);
}
...
inline cusolverStatus_t getrs_cuda<float>(cusolverDnHandle_t handle,
                                          ...
                                          int ldb,
                                          int* dinfo) {
    return cusolverDnSgetrs(handle, trans, n, nrhs, A_data, lda, ipiv_data, B_data, ldb, dinfo);
}
...
inline cusolverStatus_t getrs_cuda<double>(cusolverDnHandle_t handle,
                                           ...
                                           int ldb,
                                           int* dinfo) {
    return cusolverDnDgetrs(handle, trans, n, nrhs, A_data, lda, ipiv_data, B_data, ldb, dinfo);
}

template <>
inline cusolverStatus_t geqrf_cuda_buffersize<float>(cusolverDnHandle_t handle, int m, int n, int lda, int* len) {
    return cusolverDnSgeqrf_bufferSize(handle, m, n, NULL, lda, len);
}

template <>
inline cusolverStatus_t geqrf_cuda_buffersize<double>(cusolverDnHandle_t handle, int m, int n, int lda, int* len) {
    return cusolverDnDgeqrf_bufferSize(handle, m, n, NULL, lda, len);
}

template <>
inline cusolverStatus_t geqrf_cuda<float>(
        cusolverDnHandle_t handle, int m, int n, float* A, int lda, float* tau, float* workspace, int len, int* dinfo) {
...
inline cusolverStatus_t ormqr_cuda_buffersize<float>(cusolverDnHandle_t handle,
                                                     ...
                                                     int ldc,
                                                     int* len) {
    return cusolverDnSormqr_bufferSize(handle, side, trans, m, n, k, NULL, lda, NULL, NULL, ldc, len);
}
...
inline cusolverStatus_t ormqr_cuda_buffersize<double>(cusolverDnHandle_t handle,
                                                      ...
                                                      int ldc,
                                                      int* len) {
    return cusolverDnDormqr_bufferSize(handle, side, trans, m, n, k, NULL, lda, NULL, NULL, ldc, len);
}
...
inline cusolverStatus_t ormqr_cuda<float>(cusolverDnHandle_t handle,
                                          ...
                                          int len,
                                          int* dinfo) {
    return cusolverDnSormqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, workspace, len, dinfo);
}
...
inline cusolverStatus_t ormqr_cuda<double>(cusolverDnHandle_t handle,
                                           ...
                                           int len,
                                           int* dinfo) {
    return cusolverDnDormqr(handle, side, trans, m, n, k, A, lda, tau, C, ldc, workspace, len, dinfo);
}

template <>
inline cusolverStatus_t gesvd_cuda_buffersize<float>(cusolverDnHandle_t handle, int m, int n, int* len) {
    return cusolverDnSgesvd_bufferSize(handle, m, n, len);
}

template <>
inline cusolverStatus_t gesvd_cuda_buffersize<double>(cusolverDnHandle_t handle, int m, int n, int* len) {
...
inline cusolverStatus_t gesvd_cuda<float>(cusolverDnHandle_t handle,
                                          ...
                                          float* rwork,
                                          int* dinfo) {
    return cusolverDnSgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, workspace, len, rwork, dinfo);
}
...
inline cusolverStatus_t gesvd_cuda<double>(cusolverDnHandle_t handle,
                                           ...
                                           double* rwork,
                                           int* dinfo) {
    return cusolverDnDgesvd(handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, workspace, len, rwork, dinfo);
}
