...
#include "simulator/cloth/triangle_app.h"
...
void TriangleApp::InitializeCloth(Entity* entity, const physx::PxVec3& offset) {
    ...
    cloth_mesh.AttachClothPlaneByAngles(39, 44);
    ...
    physx::PxVec3 mesh_offset(0.0f, 11.0f, -1.0f);
    auto mesh = GenerateIcosahedron(1.5f, 1);
    mesh.ApplyTransform(physx::PxMat44(physx::PxTransform(mesh_offset)));

    // assign as collision data
    physx::PxVec3* collision_triangles;
    int vertex_count = mesh.GenerateTriangleList(&collision_triangles);
    nv::cloth::Range<const physx::PxVec3> tr_range(&collision_triangles[0], &collision_triangles[0] + vertex_count);
    cloth_actor_.cloth->setTriangles(tr_range, 0, 0);
