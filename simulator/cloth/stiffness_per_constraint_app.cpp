...
#include "simulator/cloth/stiffness_per_constraint_app.h"
...
void StiffnessPerConstraintApp::InitializeCloth(Entity* entity, const physx::PxVec3& offset) {
    ...
    cloth_mesh.GeneratePlaneCloth(5.f, 6.25f, 20, 20, false, transform);
    cloth_mesh.AttachClothPlaneByAngles(39, 39);
    ...
    cloth_actor_.cloth->setTetherConstraintStiffness(0.1);  // new term
    cloth_actor_.cloth->setTetherConstraintScale(1.5f);
    cloth_actor_.cloth->setDragCoefficient(0.1);
    cloth_actor_.cloth->setSolverFrequency(120.0f);
