...
#include "simulator/cloth/geodesic_app.h"
...
void GeodesicApp::InitializeCloth(Entity* entity, int index, const physx::PxVec3& offset, bool geodesic) {
    ...
    cloth_mesh.GeneratePlaneCloth(6.f, 10.0f, 20, 20, false, transform, true, true);

    nv::cloth::ClothMeshDesc mesh_desc = cloth_mesh.GetClothMeshDesc();
    nv::cloth::Vector<int32_t>::Type phase_type_info;
    fabric_[index] = NvClothCookFabricFromMesh(factory_, mesh_desc, physx::PxVec3(0.0f, 0.0f, 1.0f), &phase_type_info,
                                               geodesic);  // new term
    ...
    cloth_actor_[index].cloth->setTetherConstraintStiffness(0.1);
