...
ResourceReplay::ResourceReplay() {
    stream_resources_[ResourceType::SHADER_MODULE] = std::bind(&ResourceReplay::CreateShaderModule, this,
                                                               std::placeholders::_1, std::placeholders::_2);
    stream_resources_[ResourceType::PIPELINE_LAYOUT] = std::bind(&ResourceReplay::CreatePipelineLayout, this,
                                                                 std::placeholders::_1, std::placeholders::_2);
    stream_resources_[ResourceType::RENDER_PASS] = std::bind(&ResourceReplay::CreateRenderPass, this,
                                                             std::placeholders::_1, std::placeholders::_2);
    stream_resources_[ResourceType::GRAPHICS_PIPELINE] = std::bind(&ResourceReplay::CreateGraphicsPipeline, this,
                                                                   std::placeholders::_1, std::placeholders::_2);
}
