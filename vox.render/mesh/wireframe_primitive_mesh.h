...
#ifndef DIGITALVOX_VOX_RENDER_MESH_WIREFRAME_PRIMITIVE_MESH_H_
#define DIGITALVOX_VOX_RENDER_MESH_WIREFRAME_PRIMITIVE_MESH_H_
...
#endif /* DIGITALVOX_VOX_RENDER_MESH_WIREFRAME_PRIMITIVE_MESH_H_ */
