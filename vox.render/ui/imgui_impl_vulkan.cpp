...
//  2021-10-15: Vulkan: Call vkCmdSetScissor() at the end of render a full-viewport to reduce likehood of issues with
//  people using VK_DYNAMIC_STATE_SCISSOR in their app without calling vkCmdSetScissor() explicitly every frame.
...
static void ImGui_ImplVulkan_CreateDescriptorSetLayout(VkDevice device, const VkAllocationCallbacks *allocator) {
    ImGui_ImplVulkan_Data *bd = ImGui_ImplVulkan_GetBackendData();
    if (bd->DescriptorSetLayout) return;
