...
DescriptorSet &RenderFrame::request_descriptor_set(DescriptorSetLayout &descriptor_set_layout,
    ...
    auto &descriptor_pool = request_resource(device, nullptr, *descriptor_pools.at(thread_index),
                                             descriptor_set_layout);
    return request_resource(device, nullptr, *descriptor_sets.at(thread_index), descriptor_set_layout,
