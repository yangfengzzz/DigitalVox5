...
resource_cache_{*this} {
    ...
    if (is_extension_supported("VK_KHR_performance_query") &&
        ...
        auto perf_counter_features = gpu.request_extension_features<VkPhysicalDevicePerformanceQueryFeaturesKHR>(
                                                                                                                 VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR);
        auto host_query_reset_features = gpu.request_extension_features<VkPhysicalDeviceHostQueryResetFeatures>(
...
VkBuffer Device::create_buffer(VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkDeviceSize size,
...
void Device::copy_buffer(vox::core::Buffer &src, vox::core::Buffer &dst, VkQueue queue,
