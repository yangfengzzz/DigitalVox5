...
public:
     ...
     * @return Whether it succeded or not
     */
    VkResult begin(VkCommandBufferUsageFlags flags, const RenderPass *render_pass, const Framebuffer *framebuffer,
    ...
    void
    draw_indexed_indirect(const core::Buffer &buffer, VkDeviceSize offset, uint32_t draw_count, uint32_t stride);
    ...
    void
    blit_image(const core::Image &src_img, const core::Image &dst_img, const std::vector<VkImageBlit> &regions);
    
    void resolve_image(const core::Image &src_img, const core::Image &dst_img,
    ...
    void
    copy_image(const core::Image &src_img, const core::Image &dst_img, const std::vector<VkImageCopy> &regions);
    
    void copy_buffer_to_image(const core::Buffer &buffer, const core::Image &image,
                              const std::vector<VkBufferImageCopy> &regions);
    
    void copy_image_to_buffer(const core::Image &image, VkImageLayout image_layout, const core::Buffer &buffer,
                              const std::vector<VkBufferImageCopy> &regions);
