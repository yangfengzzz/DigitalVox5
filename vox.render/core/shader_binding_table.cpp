...
device_{device} {
    ...
    strided_device_address_region_.deviceAddress = vkGetBufferDeviceAddressKHR(device.get_handle(),
...
vox::core::ShaderBindingTable::get_strided_device_address_region() const {
