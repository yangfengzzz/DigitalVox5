...
size_t ResourceRecord::register_shader_module(VkShaderStageFlagBits stage, const ShaderSource &glsl_source,
    ...
    write(stream_, ResourceType::SHADER_MODULE, stage, glsl_source.get_source(), entry_point,
...
size_t
ResourceRecord::register_graphics_pipeline(VkPipelineCache /*pipeline_cache*/, PipelineState &pipeline_state) {
