...
size_t ResourceRecord::RegisterShaderModule(VkShaderStageFlagBits stage, const ShaderSource &glsl_source,
...
size_t
ResourceRecord::RegisterGraphicsPipeline(VkPipelineCache /*pipeline_cache*/ pipeline_cache, PipelineState &pipeline_state) {
    ...
    Write(stream_,
          ResourceType::GRAPHICS_PIPELINE,
