...
std::string ToString(VkSurfaceTransformFlagBitsKHR transform_flag) {
    switch (transform_flag) {
        ...
        case VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR:return "SURFACE_TRANSFORM_INHERIT";
        case VK_SURFACE_TRANSFORM_FLAG_BITS_MAX_ENUM_KHR:return "SURFACE_TRANSFORM_FLAG_BITS_MAX_ENUM";
        default:return "[Unknown transform flag]";
    }
}
...
std::string ToString(VkSurfaceFormatKHR surface_format) {
    ...
    switch (surface_format.colorSpace) {
        case VK_COLORSPACE_SRGB_NONLINEAR_KHR:surface_format_string += "VK_COLORSPACE_SRGB_NONLINEAR_KHR";
            break;
        default:surface_format_string += "UNKNOWN COLOR SPACE";
    }
...
std::string ToString(VkImageTiling tiling) {
    switch (tiling) {
        ...
        default:return "UNKOWN_TILING_METHOD";
    }
}
...
std::string ToString(VkImageType type) {
    switch (type) {
        ...
        default:return "UNKOWN_IMAGE_TYPE";
    }
}
...
std::string ToString(VkBlendFactor blend) {
    switch (blend) {
        ...
        default:return "Unknown Blend Factor";
    }
}
...
std::string ToString(ShaderResourceType type) {
    switch (type) {
        ...
        case ShaderResourceType::IMAGE_SAMPLER:return "ImageSampler";
        case ShaderResourceType::IMAGE_STORAGE:return "ImageStorage";
        case ShaderResourceType::SAMPLER:return "Sampler";
        case ShaderResourceType::BUFFER_UNIFORM:return "BufferUniform";
        case ShaderResourceType::BUFFER_STORAGE:return "BufferStorage";
        case ShaderResourceType::PUSH_CONSTANT:return "PushConstant";
        case ShaderResourceType::SPECIALIZATION_CONSTANT:return "SpecializationConstant";
