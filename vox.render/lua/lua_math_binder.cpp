...
void LuaMathsBinder::BindMaths(sol::state &lua_state) {
    ...
    // MARK: - Vector3
    lua_state.new_usertype<Vector3F>(
            "Vector3F",
            /* Constructors */
    ...
    // MARK: - Vector4
    lua_state.new_usertype<Vector4F>(
            "Vector4F",
            /* Constructors */
    ...
    // MARK: - Point3
    lua_state.new_usertype<Point3F>(
            "Point3F",
            /* Constructors */
    ...
    // MARK: - Matrix3x3
    lua_state.new_usertype<Matrix3x3F>(
            "Matrix3x3F",
            /* Constructors */
    ...
    // MARK: - Matrix4x4
    lua_state.new_usertype<Matrix4x4F>(
            "Matrix4x4F",
            /* Constructors */
    ...
    // MARK: - Quaternion
    lua_state.new_usertype<QuaternionF>(
            "QuaternionF",
            /* Constructors */
