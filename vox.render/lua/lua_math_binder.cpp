...
void LuaMathsBinder::bind_maths(sol::state &lua_state) {
    ...
    lua_state.new_usertype<Vector2F>("Vector2F",
                                     ...
                                     sol::resolve<Vector2F(const Vector2F &a)>(&operator-),
                                     sol::meta_function::addition,
                                     sol::resolve<Vector2F(const Vector2F &a, const Vector2F &b)>(&operator+),
                                     sol::meta_function::subtraction,
                                     sol::resolve<Vector2F(const Vector2F &a, const Vector2F &b)>(&operator-),
                                     sol::meta_function::multiplication,
                                     sol::resolve<Vector2F(const Vector2F &a, float b)>(&operator*),
        ...
        return "(" + std::to_string(target.x) + "," + std::to_string(target.y) + ")";
                                     ...
                                     /* Data */
                                     "zero",
                                     []() { return zero<Vector2F>(); },
                                     
                                     /* Methods */
                                     "length",
                                     &Vector2F::length,
                                     "lengthSquared",
                                     &Vector2F::lengthSquared,
                                     "distanceTo",
                                     &Vector2F::distanceTo,
                                     "distanceSquaredTo",
                                     &Vector2F::distanceSquaredTo,
                                     "dot",
                                     &Vector2F::dot,
                                     "cross",
                                     &Vector2F::cross,
    ...
    //MARK: - Vector3
    lua_state.new_usertype<Vector3F>("Vector3F",
                                     /* Constructors */
                                     sol::constructors<Vector3F(), Vector3F(float, float, float)>(),
                                     
                                     /* Operators */
                                     sol::meta_function::unary_minus,
                                     sol::resolve<Vector3F(const Vector3F &a)>(&operator-),
                                     sol::meta_function::addition,
                                     sol::resolve<Vector3F(const Vector3F &a, const Vector3F &b)>(&operator+),
                                     sol::meta_function::subtraction,
                                     sol::resolve<Vector3F(const Vector3F &a, const Vector3F &b)>(&operator-),
                                     sol::meta_function::multiplication,
                                     sol::resolve<Vector3F(const Vector3F &a, float b)>(&operator*),
                                     sol::meta_function::division,
                                     sol::resolve<Vector3F(const Vector3F &a, float b)>(&operator/),
                                     sol::meta_function::equal_to,
                                     &Vector3F::operator==,
    ...
    lua_state.new_usertype<Vector4F>("Vector4F",
                                     ...
                                     /* Operators */
                                     sol::meta_function::unary_minus,
                                     sol::resolve<Vector4F(const Vector4F &a)>(&operator-),
                                     sol::meta_function::addition,
                                     sol::resolve<Vector4F(const Vector4F &a, const Vector4F &b)>(&operator+),
                                     sol::meta_function::subtraction,
                                     sol::resolve<Vector4F(const Vector4F &a, const Vector4F &b)>(&operator-),
                                     sol::meta_function::multiplication,
                                     sol::resolve<Vector4F(const Vector4F &a, float b)>(&operator*),
                                     sol::meta_function::division,
                                     sol::resolve<Vector4F(const Vector4F &a, float b)>(&operator/),
                                     sol::meta_function::equal_to,
                                     &Vector4F::operator==,
        ...
        + "," + std::to_string(target.z) + "," + std::to_string(target.w) + ")";
                                     ...
                                     /* Data */
                                     "zero",
                                     []() { return zero<Vector4F>(); },
                                     
                                     /* Methods */
                                     "length",
                                     &Vector4F::length,
                                     "lengthSquared",
                                     &Vector4F::lengthSquared,
                                     "distanceTo",
                                     &Vector4F::distanceTo,
                                     "distanceSquaredTo",
                                     &Vector4F::distanceSquaredTo,
                                     "dot",
                                     &Vector4F::dot,
                                     "normalize",
                                     &Vector4F::normalize
    ...
    //MARK: - Point3
    lua_state.new_usertype<Point3F>("Point3F",
                                    /* Constructors */
    ...
    //MARK: - Matrix3x3
    lua_state.new_usertype<Matrix3x3F>("Matrix3x3F",
                                       /* Constructors */
                                       ...
                                       /* Operators */
                                       sol::meta_function::unary_minus,
                                       sol::resolve<Matrix3x3F(const Matrix3x3F &a)>(&operator-),
                                       sol::meta_function::addition,
                                       ...
                                       "makeRotationMatrix",
                                       &Matrix3x3F::makeRotationMatrix
                                       
                                       );
    
    //MARK: - Matrix4x4
    lua_state.new_usertype<Matrix4x4F>("Matrix4x4F",
                                       /* Constructors */
                                       ...
                                       /* Operators */
                                       sol::meta_function::unary_minus,
                                       sol::resolve<Matrix4x4F(const Matrix4x4F &a)>(&operator-),
                                       sol::meta_function::addition,
    ...
    //MARK: - Quaternion
    lua_state.new_usertype<QuaternionF>("QuaternionF",
                                        /* Constructors */
                                        ...
                                        sol::meta_function::multiplication,
                                        sol::resolve<QuaternionF(const QuaternionF &a, float b)>(&operator*),
                                        sol::meta_function::equal_to,
        ...
        + "," + std::to_string(target.z) + "," + std::to_string(target.w) + ")";
                                        ...
                                        "makeRotationEuler",
                                        &QuaternionF::makeRotationEuler,
                                        "makeRotationYawPitchRoll",
                                        &QuaternionF::makeRotationYawPitchRoll,
                                        "makeRotationX",
                                        &QuaternionF::makeRotationX,
                                        "makeRotationY",
                                        &QuaternionF::makeRotationY,
                                        "makeRotationZ",
