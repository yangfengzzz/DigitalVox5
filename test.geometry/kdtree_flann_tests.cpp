...
TEST(KDTreeFlann, SearchKNN) {
    std::vector<int> ref_indices = {27, 48, 4,  77, 90, 7,  54, 17, 76, 38, 39, 60, 15, 84, 11,
                                    57, 3,  32, 99, 36, 52, 40, 26, 59, 22, 97, 20, 42, 73, 24};

    std::vector<double> ref_distance2 = {0.000000,  4.684353,  4.996539,  9.191849,  10.034604, 10.466745,
...
TEST(KDTreeFlann, SearchRadius) {
    std::vector<int> ref_indices = {27, 48, 4, 77, 90, 7, 54, 17, 76, 38, 39, 60, 15, 84, 11, 57, 3, 32, 99, 36, 52};

    std::vector<double> ref_distance2 = {0.000000,  4.684353,  4.996539,  9.191849,  10.034604, 10.466745, 10.649751,
                                         11.434066, 12.089195, 13.345638, 13.696270, 14.016148, 16.851978, 17.073435,
                                         18.254518, 20.019994, 21.496347, 23.077277, 23.692427, 23.809303, 24.104578};
...
TEST(KDTreeFlann, SearchHybrid) {
    ...
    std::vector<double> ref_distance2 = {0.000000,  4.684353,  4.996539,  9.191849,  10.034604,
