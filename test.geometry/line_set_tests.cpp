...
TEST(LineSet, Constructor) {
    ...
    EXPECT_EQ(geometry::Geometry::GeometryType::LINE_SET, ls.GetGeometryType());
...
TEST(LineSet, Transform) {
    std::vector<Eigen::Vector3d> ref_points = {{1.411252, 4.274168, 3.130918}, {1.231757, 4.154505, 3.183678},
    ...
    std::vector<Eigen::Vector2i> ref_lines = {{839, 392}, {780, 796}, {909, 196}, {333, 764}, {274, 552},
...
TEST(LineSet, CreateLineSetFromPointCloudCorrespondences) {
    ...
    std::vector<Eigen::Vector2i> ref_lines = {{8, 13}, {7, 17}, {9, 11}, {3, 17}, {2, 15},
    ...
    auto ls = geometry::LineSet::CreateFromPointCloudCorrespondences(pc0, pc1, correspondence);
