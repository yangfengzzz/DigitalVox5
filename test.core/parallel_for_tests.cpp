...
TEST(ParallelFor, LambdaCPU) {
    ...
    core::ParallelFor(device, tensor.NumElements(), [&](int64_t idx) { tensor.GetDataPtr<int64_t>()[idx] = idx; });
...
TEST(ParallelFor, VectorizedLambda5) {
    ...
    core::ParallelFor(
            ...
            OPEN3D_VECTORIZED(ISPCKernel5, v.data(), &arg2, &arg3, &arg4, &arg5));
...
TEST(ParallelFor, VectorizedLambda6) {
    ...
    core::ParallelFor(
            ...
            OPEN3D_VECTORIZED(ISPCKernel6, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6));
...
TEST(ParallelFor, VectorizedLambda7) {
    ...
    core::ParallelFor(
            ...
            OPEN3D_VECTORIZED(ISPCKernel7, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6, &arg7));
...
TEST(ParallelFor, VectorizedLambda8) {
    ...
    core::ParallelFor(
            ...
            OPEN3D_VECTORIZED(ISPCKernel8, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8));
...
TEST(ParallelFor, VectorizedLambda9) {
    ...
    core::ParallelFor(
            ...
            OPEN3D_VECTORIZED(ISPCKernel9, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda1) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                core::Device("CPU:0"), v.size(),
                [&](int64_t idx) { v[idx] = idx == 0 ? GetInitialValue<scalar_t>() : idx; },
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel1, v.data()));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda2) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel2, v.data(), &arg2));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda3) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel3, v.data(), &arg2, &arg3));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda4) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel4, v.data(), &arg2, &arg3, &arg4));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda5) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel5, v.data(), &arg2, &arg3, &arg4, &arg5));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda6) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel6, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda7) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel7, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6,
                                           &arg7));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda8) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel8, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6,
                                           &arg7, &arg8));
...
TEST_P(ParallelForPermuteDtypesWithBool, VectorizedTemplateLambda9) {
    ...
    DISPATCH_DTYPE_TO_TEMPLATE_WITH_BOOL(dtype, [&]() {
        core::ParallelFor(
                ...
                OPEN3D_TEMPLATE_VECTORIZED(scalar_t, TemplateISPCKernel9, v.data(), &arg2, &arg3, &arg4, &arg5, &arg6,
                                           &arg7, &arg8, &arg9));
