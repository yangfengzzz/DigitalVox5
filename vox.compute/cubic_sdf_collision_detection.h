...
#include "vox.compute/discregrid/cubic_lagrange_discrete_grid.h"
#include "vox.compute/discregrid/triangle_mesh.h"
#include "vox.compute/discregrid/triangle_mesh_distance.h"
#include "vox.compute/distance_field_collision_detection.h"
...
public:
    using Grid = vox::compute::discregrid::CubicLagrangeDiscreteGrid;
    using GridPtr = std::shared_ptr<vox::compute::discregrid::CubicLagrangeDiscreteGrid>;
