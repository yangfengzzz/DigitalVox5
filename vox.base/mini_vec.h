...
#define DEFINE_OPERATOR(op, opas)                                                             \
    template <class T, int N>                                                                 \
    FN_SPECIFIERS MiniVec<T, N> operator op(const MiniVec<T, N>& a, const MiniVec<T, N>& b) { \
        MiniVec<T, N> c;                                                                      \
        ...
        return c;                                                                             \
                                                                                              ...
                                                                                              \
    template <class T, int N>                                                                 \
    FN_SPECIFIERS void operator opas(MiniVec<T, N>& a, const MiniVec<T, N>& b) {              \
...
#define DEFINE_OPERATOR(op)                                                                      \
    template <class T, int N>                                                                    \
    FN_SPECIFIERS MiniVec<bool, N> operator op(const MiniVec<T, N>& a, const MiniVec<T, N>& b) { \
        MiniVec<bool, N> c;                                                                      \
        for (int i = 0; i < N; ++i) c[i] = a[i] op b[i];                                         \
        return c;                                                                                \
    }                                                                                            \
