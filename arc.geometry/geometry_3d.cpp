...
Eigen::Matrix3d Geometry3D::GetRotationMatrixFromXYZ(const Eigen::Vector3d& rotation) {
    return arc::utility::RotationMatrixX(rotation(0)) * arc::utility::RotationMatrixY(rotation(1)) *
           arc::utility::RotationMatrixZ(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromYZX(const Eigen::Vector3d& rotation) {
    return arc::utility::RotationMatrixY(rotation(0)) * arc::utility::RotationMatrixZ(rotation(1)) *
           arc::utility::RotationMatrixX(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromZXY(const Eigen::Vector3d& rotation) {
    return arc::utility::RotationMatrixZ(rotation(0)) * arc::utility::RotationMatrixX(rotation(1)) *
           arc::utility::RotationMatrixY(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromXZY(const Eigen::Vector3d& rotation) {
    return arc::utility::RotationMatrixX(rotation(0)) * arc::utility::RotationMatrixZ(rotation(1)) *
           arc::utility::RotationMatrixY(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromZYX(const Eigen::Vector3d& rotation) {
    return arc::utility::RotationMatrixZ(rotation(0)) * arc::utility::RotationMatrixY(rotation(1)) *
           arc::utility::RotationMatrixX(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromYXZ(const Eigen::Vector3d& rotation) {
    return arc::utility::RotationMatrixY(rotation(0)) * arc::utility::RotationMatrixX(rotation(1)) *
           arc::utility::RotationMatrixZ(rotation(2));
}
