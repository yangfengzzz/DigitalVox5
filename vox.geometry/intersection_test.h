...
public:
    ...
    /// }
    /// \endcode
    static std::optional<double> LineExactAABB(const Line3D& line, const AxisAlignedBoundingBox& box) {
    ...
    /// method
    static std::optional<double> LineSlabAABB(const Line3D& line, const AxisAlignedBoundingBox& box) {
