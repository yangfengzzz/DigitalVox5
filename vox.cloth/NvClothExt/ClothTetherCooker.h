...
public:
    ...
    \details The tether constraint in NvCloth requires rest distance and anchor index to be precomputed during cooking
    time. This cooker computes a simple Euclidean distance to closest anchor point. The Euclidean distance measure works
    reasonably for flat cloth and flags and computation time is very fast. With this cooker, there is only one tether
    anchor point per particle. \see ClothTetherGeodesicCooker for more accurate distance estimation. \param desc The
    cloth mesh descriptor prepared for cooking
    */
    ...
    */
    ...
    /**
        ...
        \details This function returns anchor indices for each particle as well as desired distance between the tether
       anchor and the particle. The user buffers should be at least as large as number of particles.
        */
