...
Simd4iZeroFactory::operator Scalar4i() const { return Scalar4i(0, 0, 0, 0); }

Simd4iScalarFactory::operator Scalar4i() const { return Scalar4i(value, value, value, value); }

Simd4iTupleFactory::operator Scalar4i() const { return reinterpret_cast<const Scalar4i&>(tuple); }

Simd4iLoadFactory::operator Scalar4i() const { return Scalar4i(ptr[0], ptr[1], ptr[2], ptr[3]); }

Simd4iAlignedLoadFactory::operator Scalar4i() const { return Scalar4i(ptr[0], ptr[1], ptr[2], ptr[3]); }
...
inline ComplementExpr<Scalar4i> operator~(const Scalar4i& v) { return ComplementExpr<Scalar4i>(v); }
...
inline Scalar4i operator+(const Scalar4i& v) { return v; }

inline Scalar4i operator+(const Scalar4i& v0, const Scalar4i& v1) {
    return Scalar4i(v0.i4[0] + v1.i4[0], v0.i4[1] + v1.i4[1], v0.i4[2] + v1.i4[2], v0.i4[3] + v1.i4[3]);
}

inline Scalar4i operator-(const Scalar4i& v) { return Scalar4i(-v.i4[0], -v.i4[1], -v.i4[2], -v.i4[3]); }
...
inline Scalar4i simd4i(const Scalar4f& v) { return reinterpret_cast<const Scalar4i&>(v); }

inline Scalar4i truncate(const Scalar4f& v) { return Scalar4i(int(v.f4[0]), int(v.f4[1]), int(v.f4[2]), int(v.f4[3])); }

inline int (&array(Scalar4i& v))[4] { return v.i4; }

inline const int (&array(const Scalar4i& v))[4] { return v.i4; }
...
inline void storeAligned(int* ptr, const Scalar4i& v) { store(ptr, v); }
...
inline Scalar4i select(const Scalar4i& mask, const Scalar4i& v0, const Scalar4i& v1) { return ((v0 ^ v1) & mask) ^ v1; }
...
inline int allTrue(const Scalar4i& v) { return v.i4[0] & v.i4[1] & v.i4[2] & v.i4[3]; }

inline int anyTrue(const Scalar4i& v) { return v.i4[0] | v.i4[1] | v.i4[2] | v.i4[3]; }
