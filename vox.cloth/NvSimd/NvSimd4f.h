 ...
 * \relates Simd4f */
inline Simd4fScalarFactory simd4f(const float& s) { return Simd4fScalarFactory(s); }

/*! \brief Load 4 float values into vector.
 * \relates Simd4f */
inline Simd4fTupleFactory simd4f(float x, float y, float z, float w) { return Simd4fTupleFactory(x, y, z, w); }
 ...
 * \relates Simd4f */
inline Simd4fTupleFactory simd4f(const Simd4iTupleFactory& v) { return reinterpret_cast<const Simd4fTupleFactory&>(v); }
 ...
 * \relates Simd4f */
inline Simd4fLoadFactory load(const float* ptr) { return Simd4fLoadFactory(ptr); }

/*! \brief Create vector from aligned float array.
 * \note \a ptr needs to be 16 byte aligned.
 * \relates Simd4f */
inline Simd4fAlignedLoadFactory loadAligned(const float* ptr) { return Simd4fAlignedLoadFactory(ptr); }

/*! \brief Create vector from float[3] \a ptr array. 4th component of simd4f will be equal to 0.0
 * \relates Simd4f */
inline Simd4fLoad3Factory load3(const float* ptr) { return Simd4fLoad3Factory(ptr); }
...
#if NV_SIMD_SSE2
#include "vox.cloth/NvSimd/sse2/NvSse2Simd4f.h"
#elif NV_SIMD_NEON
#include "vox.cloth/neon/NvNeonSimd4f.h"
#endif

#if NV_SIMD_SCALAR
#include "vox.cloth/NvSimd/scalar/NvScalarSimd4f.h"
#endif
