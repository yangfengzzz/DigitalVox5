 ...
 * \relates Simd4i */
inline Simd4iScalarFactory simd4i(const int& s) { return Simd4iScalarFactory(s); }

/*! \brief Load 4 int values into vector.
 * \relates Simd4i */
inline Simd4iTupleFactory simd4i(int x, int y, int z, int w) { return Simd4iTupleFactory(x, y, z, w); }
 ...
 * \relates Simd4i */
inline Simd4iLoadFactory load(const int* ptr) { return Simd4iLoadFactory(ptr); }

/*! \brief Create vector from aligned int array.
 * \note \a ptr needs to be 16 byte aligned.
 * \relates Simd4i */
inline Simd4iAlignedLoadFactory loadAligned(const int* ptr) { return Simd4iAlignedLoadFactory(ptr); }
...
#if NV_SIMD_SSE2
#include "vox.cloth/NvSimd/sse2/NvSse2Simd4i.h"
#elif NV_SIMD_NEON
#include "vox.cloth/neon/NvNeonSimd4i.h"
#endif
