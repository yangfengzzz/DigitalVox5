...
#include "vox.cloth/foundation/PxMat33.h"
#include "vox.cloth/foundation/PxPreprocessor.h"
...
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 sign(const physx::PxF32 a) { return physx::intrinsics::sign(a); }

/**
\brief sign returns the sign of its argument. The sign of zero is undefined.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 sign(const physx::PxF64 a) { return (a >= 0.0) ? 1.0 : -1.0; }

/**
\brief sign returns the sign of its argument. The sign of zero is undefined.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxI32 sign(const physx::PxI32 a) { return (a >= 0) ? 1 : -1; }
...
x.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 floor(const physx::PxF32 a) { return floatFloor(a); }

/**
\brief The floor function returns a floating-point value representing the largest integer that is less than or equal to
x.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 floor(const physx::PxF64 a) { return ::floor(a); }

/**
\brief The ceil function returns a single value representing the smallest integer that is greater than or equal to x.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 ceil(const physx::PxF32 a) { return ::ceilf(a); }

/**
\brief The ceil function returns a double value representing the smallest integer that is greater than or equal to x.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 ceil(const physx::PxF64 a) { return ::ceil(a); }
...
If the value of y is 0.0, mod returns a quiet NaN.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 mod(const physx::PxF64 x, const physx::PxF64 y) { return ::fmod(x, y); }

/**
\brief Square.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 sqr(const physx::PxF32 a) { return a * a; }

/**
\brief Square.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 sqr(const physx::PxF64 a) { return a * a; }

/**
\brief Calculates x raised to the power of y.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 pow(const physx::PxF32 x, const physx::PxF32 y) { return ::powf(x, y); }

/**
\brief Calculates x raised to the power of y.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 pow(const physx::PxF64 x, const physx::PxF64 y) { return ::pow(x, y); }

/**
\brief Calculates e^n
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 exp(const physx::PxF32 a) { return ::expf(a); }
/**

\brief Calculates e^n
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 exp(const physx::PxF64 a) { return ::exp(a); }
...
\brief Calculates 2^n
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 exp2(const physx::PxF64 a) { return ::exp(a * 0.693147180559945309417); }

/**
\brief Calculates logarithms.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 logE(const physx::PxF32 a) { return ::logf(a); }

/**
\brief Calculates logarithms.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 logE(const physx::PxF64 a) { return ::log(a); }
...
\brief Calculates logarithms.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 log2(const physx::PxF64 a) { return ::log(a) / 0.693147180559945309417; }

/**
\brief Calculates logarithms.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 log10(const physx::PxF32 a) { return ::log10f(a); }

/**
\brief Calculates logarithms.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 log10(const physx::PxF64 a) { return ::log10(a); }

/**
\brief Converts degrees to radians.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 degToRad(const physx::PxF32 a) { return 0.01745329251994329547f * a; }

/**
\brief Converts degrees to radians.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 degToRad(const physx::PxF64 a) { return 0.01745329251994329547 * a; }

/**
\brief Converts radians to degrees.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF32 radToDeg(const physx::PxF32 a) { return 57.29577951308232286465f * a; }

/**
\brief Converts radians to degrees.
*/
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxF64 radToDeg(const physx::PxF64 a) { return 57.29577951308232286465 * a; }
...
PX_CUDA_CALLABLE PX_INLINE physx::PxQuat rotationArc(const physx::PxVec3& v0, const physx::PxVec3& v1) {
    ...
    if (d <= -0.99999f)
        return (physx::PxAbs(v0.x) < 0.1f ? physx::PxQuat(0.0f, v0.z, -v0.y, 0.0f)
                                          : physx::PxQuat(v0.y, -v0.x, 0.0, 0.0))
                .getNormalized();
...
PX_CUDA_CALLABLE PX_FORCE_INLINE physx::PxVec3 computeBarycentricPoint(
        const physx::PxVec3& p0, const physx::PxVec3& p1, const physx::PxVec3& p2, physx::PxReal u, physx::PxReal v) {
    // This seems to confuse the compiler...
    // return (1.0f - u - v)*p0 + u*p1 + v*p2;
    const physx::PxF32 w = 1.0f - u - v;
    return physx::PxVec3(w * p0.x + u * p1.x + v * p2.x, w * p0.y + u * p1.y + v * p2.y,
...
PX_FORCE_INLINE void normalToTangents(const physx::PxVec3& normal, physx::PxVec3& tangent0, physx::PxVec3& tangent1) {
    tangent0 = physx::PxAbs(normal.x) < 0.70710678f ? physx::PxVec3(0, -normal.z, normal.y)
                                                    : physx::PxVec3(-normal.y, normal.x, 0);
    tangent0.normalize();
...
PX_CUDA_CALLABLE PX_INLINE physx::PxVec3 ellipseClamp(const physx::PxVec3& point, const physx::PxVec3& radii) {
    ...
    if (radii.y >= radii.z) {
        if (q.z < tinyEps) return physx::PxVec3(0, point.y > 0 ? radii.y : -radii.y, 0);
    } else {
        if (q.y < tinyEps) return physx::PxVec3(0, 0, point.z > 0 ? radii.z : -radii.z);
    }
...
PX_CUDA_CALLABLE PX_INLINE physx::PxReal tanHalf(physx::PxReal sin, physx::PxReal cos) { return sin / (1 + cos); }

PX_INLINE physx::PxQuat quatFromTanQVector(const physx::PxVec3& v) {
    physx::PxReal v2 = v.dot(v);
    if (v2 < 1e-12f) return physx::PxQuat(physx::PxIdentity);
    physx::PxReal d = 1 / (1 + v2);
    return physx::PxQuat(v.x * 2, v.y * 2, v.z * 2, 1 - v2) * d;
}

PX_FORCE_INLINE physx::PxVec3 cross100(const physx::PxVec3& b) { return physx::PxVec3(0.0f, -b.z, b.y); }
PX_FORCE_INLINE physx::PxVec3 cross010(const physx::PxVec3& b) { return physx::PxVec3(b.z, 0.0f, -b.x); }
PX_FORCE_INLINE physx::PxVec3 cross001(const physx::PxVec3& b) { return physx::PxVec3(-b.y, b.x, 0.0f); }

PX_INLINE void decomposeVector(physx::PxVec3& normalCompo,
                               physx::PxVec3& tangentCompo,
                               const physx::PxVec3& outwardDir,
...
// }
PX_INLINE physx::PxU32 getNextIndex3(physx::PxU32 i) { return (i + 1 + (i >> 1)) & 3; }
...
PX_INLINE physx::PxMat33 rotFrom2Vectors(const physx::PxVec3& from, const physx::PxVec3& to) {
    ...
    if ((from - to).magnitudeSquared() < 1e-4f) return physx::PxMat33(physx::PxIdentity);
...
NV_CLOTH_IMPORT void integrateTransform(const physx::PxTransform& curTrans,
