...
#define NV_CLOTH_ENABLE_CUDA 0
#endif

#ifndef NV_CLOTH_ENABLE_DX11
#define NV_CLOTH_ENABLE_DX11 0
#endif
...
#include "vox.cloth/cuda/CuFactory.h"

nv::cloth::Factory* NvClothCreateFactoryCUDA(CUcontext context) { return NV_CLOTH_NEW(nv::cloth::CuFactory)(context); }
#else
...
#include "vox.cloth/dx/dxFactory.h"
...
NV_CLOTH_API(void) NvClothDestroyFactory(nv::cloth::Factory* factory) { NV_CLOTH_DELETE(factory); }

NV_CLOTH_API(bool) NvClothCompiledWithCudaSupport() { return NV_CLOTH_ENABLE_CUDA == 1; }
NV_CLOTH_API(bool) NvClothCompiledWithDxSupport() { return NV_CLOTH_ENABLE_DX11 == 1; }
