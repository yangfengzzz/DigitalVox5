...
int32_t atomicIncrement(volatile int32_t* val) { return __sync_add_and_fetch(val, 1); }

int32_t atomicDecrement(volatile int32_t* val) { return __sync_sub_and_fetch(val, 1); }

int32_t atomicAdd(volatile int32_t* val, int32_t delta) { return __sync_add_and_fetch(val, delta); }
