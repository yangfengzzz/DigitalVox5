...
static const vox::Color DEFAULT_BGCOLOR(0.001f, 0.001f, 0.001f, 0.0f);

struct Widget::Impl {
    Rect frame_;
    vox::Color bg_color_ = DEFAULT_BGCOLOR;
...
Widget::EventResult Widget::Mouse(const vox::MouseButtonInputEvent& e) {
    if (!impl_->is_visible_) {
