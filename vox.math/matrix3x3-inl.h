...
Matrix<T, 3, 3> Matrix<T, 3, 3>::rotate(T r) const {
    ...
    const T &a11 = _elements[0], a12 = _elements[1], a13 = _elements[2];
    const T &a21 = _elements[3], a22 = _elements[4], a23 = _elements[5];
    const T &a31 = _elements[6], a32 = _elements[7], a33 = _elements[8];
