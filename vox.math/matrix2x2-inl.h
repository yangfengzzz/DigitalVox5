...
Vector<T, 2> Matrix<T, 2, 2>::mul(const Vector<T, 2> &v) const {
    return Vector<T, 2>(_elements[0] * v.x + _elements[2] * v.y, _elements[1] * v.x + _elements[3] * v.y);
}
...
T Matrix<T, 2, 2>::absmin() const {
    return ::vox::absmin(::vox::absmin(_elements[0], _elements[1]), ::vox::absmin(_elements[2], _elements[3]));
}

template <typename T>
T Matrix<T, 2, 2>::absmax() const {
    return ::vox::absmax(::vox::absmax(_elements[0], _elements[1]), ::vox::absmax(_elements[2], _elements[3]));
}
